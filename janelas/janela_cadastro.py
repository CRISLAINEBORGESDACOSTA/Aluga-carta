...
class CadastroVeiculo(ctk.CTkToplevel):
    def __init__(self, master=None):
        ...
        self.labelTitulo = ctk.CTkLabel(self.frameTitulo, text='Cadastrar Veículo', font=('Open Sans', 26, 'bold'),text_color='white')
